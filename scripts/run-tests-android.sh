...
echo "▶ Running tests..."
TEST_EXIT_CODE=0
# ANDROID_DEVICE_NAME defaults to emulator-5554 in CI; set to emulator-5556 locally if needed
ANDROID_DEVICE_NAME="${ANDROID_DEVICE_NAME:-emulator-5556}" npx wdio run config/wdio.android.conf.ts || TEST_EXIT_CODE=$?
